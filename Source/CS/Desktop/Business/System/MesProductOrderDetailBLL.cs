...
{
    /// <summary>
    /// 描述: 业务层 -- Mes_ProductOrderDetail
    /// </summary>
    public partial class MesProductOrderDetailBLL
    {
        ...
        /// </summary>
        /// <returns></returns>
		public List<MesProductOrderDetailEntity> GetList()
        {
            try
            {
                var strSql = new StringBuilder();
				strSql.Append("SELECT * FROM Mes_ProductOrderDetail");
                var rows = db.ExecuteObjects<MesProductOrderDetailEntity>(strSql.ToString());
                return rows;
            }
            catch (Exception)
            {
        ...
        /// <returns>MesProductOrderDetail</returns>
		public MesProductOrderDetailEntity GetEntity(string keyValue)
        {
            try
            {
                var strSql = new StringBuilder();
                ...
                var rowData = db.ExecuteObject<MesProductOrderDetailEntity>(strSql.ToString(),paramList.ToArray());
                return rowData;
            }
            catch (Exception)
            {
        ...
        public int DeleteEntity(string keyValue)
        {
            ...
            {
                var strSql = new StringBuilder();
				strSql.Append("DELETE Mes_ProductOrderDetail");
                strSql.Append(" WHERE ID=@ID");
				var paramList = new List<SqlParameter>();
                paramList.Add(new SqlParameter("@ID",keyValue));
        ...
        public int SaveEntity(string keyValue,MesProductOrderDetailEntity entity)
        {
            try
            {
			    var strSql = new StringBuilder();
                ...
                {
					 strSql.Append("INSERT INTO Mes_ProductOrderDetail(");
                     strSql.Append("ID,");
                ...
                {
					 strSql.Append("UPDATE Mes_ProductOrderDetail SET ");
