...
namespace DataAccess.SQLite
{
    ...
    public static class SQLiteHelper
    {
        ...
        /// 数据库连接字符串
        /// </summary>
        public static string connectionString = Tools.ConfigManager.ReadConnectionStringByName(ConfigurationFile.WebConfig,
                    "connectionStrings");
        
        //"Data Source=" + Application.StartupPath + "\\" + System.Configuration.ConfigurationSettings.AppSettings["SfliaoDbLocal"];
        ...
        /// <returns></returns>
        public static int ExecuteNonQuery(List<string> cmds, List<SQLiteParameter[]> cmdParms)
        {
            ...
            using (SQLiteConnection con = new SQLiteConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    {
                        cmd.Parameters.Clear();//清空之前参数

                        cmd.CommandText = cmds[n];
                        foreach (SQLiteParameter parm in cmdParms[n])
