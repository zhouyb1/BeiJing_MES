...
namespace Senparc.Weixin.WxOpen
{
    ...
    public static class EncryptHelper
    {
        ...
        public static string DecodeEncryptedDataBySessionId(string sessionId, string encryptedData, string iv)
        {
            ...
            var resultStr = Helpers.EncryptHelper.DecodeEncryptedData(sessionBag.SessionKey, encryptedData, iv);
            //var resultStr = DecodeEncryptedData(sessionBag.SessionKey, encryptedData, iv);
            //var resultStr = AesDecode(encryptedData, sessionBag.SessionKey, iv);
            return resultStr;
        }
