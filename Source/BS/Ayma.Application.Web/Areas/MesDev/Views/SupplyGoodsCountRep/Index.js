        ...
        initGird: function () {
            $('#girdtable_sum').AuthorizeJfGrid({
                ...
                headData: [
                    ...
                    { label: "单位成本(元)", name: "avg_price", width: 160, align: "left", statistics: true },
                    { label: "进货总成本(元)", name: "in_amount", width: 160, align: "left", statistics: true },
                ],
                mainId:'ID',
                reloadSelected: true,
                isPage: true,
            ...
            $('#girdtable_detail').AuthorizeJfGrid({
                ...
                headData: [
                    ...
                    { label: "入库单据", name: "m_materinno", width: 160, align: "left" },
                    ...
                    { label: "单价(元)", name: "m_price", width: 160, align: "left" },
                    { label: "总价(元)", name: "amount", width: 160, align: "left", statistics: true },
