    ...
    var page = {
        ...
        initGird: function () {
            $('#girdtable').AuthorizeJfGrid({
                ...
                headData: [
                    { label: "物料编码", name: "C_Code", width: 160, align: "left"},
                    ...
                    { label: "工艺代码", name: "C_RecordCode", width: 160, align: "left" },
                    { label: "工序号", name: "C_ProNo", width: 160, align: "left" },
                    { label: "工序名称", name: "C_ProName", width: 160, align: "left" },
                    ...
                    { label: "修改时间", name: "C_UpdateDate", width: 160, align: "left"},
