    ...
    var page = {
        ...
        bind: function () {
            ...
            $('#am_print').on('click', function () {
                ...
                ayma.layerForm({
                    id: 'LivingToCookReport',
                    title: '生到熟出成率打印',
                    url: top.$.rootUrl + '/MesDev/GoodsList/PrintReport?name=' + name + "&report=LivingToCookReport&data=LivingToCook",
                    width: 1000,
                    height: 800,
                    maxmin: true,
        ...
        initGird: function () {
            $('#girdtable').jfGrid({
                url: top.$.rootUrl + '/MesDev/GoodsList/GetLivingToCookPageList',
                headData: [
                    {
                    ...
                    {
                        label: "生到熟出成率%", name: "生到熟出成率%", width: 100, align: "center", children: [
