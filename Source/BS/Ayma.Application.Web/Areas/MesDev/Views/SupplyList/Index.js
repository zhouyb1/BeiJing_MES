    ...
    var page = {
        ...
        initGird: function () {
            $('#girdtable').AuthorizeJfGrid({
                ...
                headData: [
                    { label: "供应商编码", name: "S_Code", width: 90, align: "center" },
                    { label: "供应商名称", name: "S_Name", width: 160, align: "center" },
                    { label: "资质期限", name: "S_EffectTime", width: 160, align: "center" },
                    { label: "联系人", name: "S_Person", width: 160, align: "center" },
                    { label: "联系电话", name: "S_Telephone", width: 160, align: "center" },
                    { label: "法人", name: "S_Corp", width: 100, align: "center" },
                    ...
                    { label: "资质2", name: "S_Effect2", width: 160, align: "left", hidden: true },
                    { label: "资质3", name: "S_Effect3", width: 160, align: "left", hidden: true },
                    { label: "资质4", name: "S_Effect4", width: 160, align: "left", hidden: true },
                    { label: "资质5", name: "S_Effect5", width: 160, align: "left", hidden: true },
                    { label: "备注", name: "S_Remark", width: 160, align: "left" },
                ],
                mainId:'ID',
                isPage: true,
