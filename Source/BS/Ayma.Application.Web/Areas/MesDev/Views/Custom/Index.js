        ...
        initGird: function () {
            $('#girdtable').AuthorizeJfGrid({
                ...
                headData: [
                        ...
                        { label: '资质1', name: 'S_Effect1', width: 200, align: "left", hidden: true },
                        { label: '资质2', name: 'S_Effect2', width: 200, align: "left", hidden: true },
                        { label: '资质3', name: 'S_Effect3', width: 200, align: "left", hidden: true },
                        { label: '资质4', name: 'S_Effect4', width: 200, align: "left", hidden: true },
                        { label: '资质5', name: 'S_Effect5', width: 200, align: "left", hidden: true },
