        ...
        bind: function () {
            ...
            $('#girdtable_sum').on('dblclick', function () {
                ...
                //var module = top.ayma.clientdata.get(['modulesMap', '6c1dfb3e-9f16-40db-9d72-4fe5d604b06f']);//本地ID
                 var module = top.ayma.clientdata.get(['modulesMap', 'id="2f8b20ae-293b-4431-9a11-16a3e801f019"']);//京铁列服ID
        ...
        initGird: function () {
            ...
            $('#girdtable_detail').jfGrid({
                ...
                headData: [
                               ...
                               { label: "无税价格", name: "m_price", width: 70, align: "left" },
                               { label: "备注", name: "m_remark", width: 70, align: "left" },
                               { label: "入库时间", name: "m_orderdate", width: 150, align: "left" },
            ...
            $('#girdtable_Outbounddetails').jfGrid({
                ...
                headData: [
                               ...
                               { label: "出库时间", name: "p_orderdate", width: 140, align: "left" },
            ...
            $('#girdtable_withdrawingdetails').jfGrid({
                ...
                headData: [
                               ...
                               { label: "退库时间", name: "b_orderdate", width: 130, align: "left" },
            ...
            $('#girdtable_materialssales').jfGrid({
                ...
                headData: [
                               ...
                               { label: "销售时间", name: "s_orderdate", width: 130, align: "left" },
            ...
            $('#girdtable_scrapnumber').jfGrid({
                ...
                headData: [
                               ...
                               { label: "报废时间", name: "s_orderdate", width: 130, align: "left" },
                               { label: "添加人", name: "s_createby", width: 130, align: "left" },
            ...
            $('#girdtable_other').jfGrid({
                ...
                headData: [
                               ...
                               { label: "入库时间", name: "o_orderdate", width: 130, align: "left" },
            ...
            $('#girdtable_otherout').jfGrid({
                ...
                headData: [
                               ...
                               { label: "出库时间", name: "o_orderdate", width: 130, align: "left" },
                               { label: "添加人", name: "o_createby", width: 130, align: "left" },
            ...
            $('#girdtable_supplierback').jfGrid({
                ...
                headData: [
                               ...
                               { label: "价格", name: "b_price", width: 80, align: "left" },
                               { label: "备注", name: "b_remark", width: 80, align: "left" },
                               { label: "退供应商时间", name: "b_orderdate", width: 130, align: "left" },
                               { label: "添加人", name: "b_createby", width: 80, align: "left" },
                ],
                mainId: 'ID',
                footerrow: true,
