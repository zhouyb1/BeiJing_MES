        ...
        initGird: function () {
            $('#girdtable_sum').jfGrid({
                ...
                headData: [
                    ...
                    { label: "期初库存", name: "initialinventory", width: 90, align: "center", statistics: true },
                    { label: "期初金额", name: "initialamount", width: 90, align: "center", statistics: true },
                    { label: "期末库存", name: "endinginventory", width: 90, align: "center", statistics: true },
                    { label: "期末金额", name: "finalamount", width: 160, align: "center", statistics: true },
                    { label: "单价", name: "price", width: 90, align: "center" },
                    { label: "次品退库数量", name: "back_qty", width: 90, align: "center", statistics: true },
                    { label: "退库数量", name: "withdrawingnumber", width: 90, align: "center" },
                    { label: "原物料销售数", name: "materialssales", width: 90, align: "center" },
                    { label: "报废数量", name: "scrapist", width: 90, align: "center" },
                    { label: "其它入库数量", name: "otherwarehouse", width: 90, align: "center" },
                    { label: "其它出库数量", name: "otheroutbound", width: 90, align: "center" },
                    { label: "退供应商数量", name: "supplierback", width: 90, align: "center" },
            ...
            $('#girdtable_detail').jfGrid({
                ...
                headData: [
                               { label: "入库单号", name: "m_materinno", width: 130, align: "center" },
                               { label: "供应商编码", name: "m_supplycode", width: 80, align: "center" },
                               { label: "供应商名称", name: "m_supplyname", width: 150, align: "center" },
                               { label: "商品编码", name: "m_goodscode", width: 80, align: "center" },
                               { label: "商品名称", name: "m_goodsname", width: 150, align: "center" },
                               { label: "仓库名称", name: "m_stockname", width: 150, align: "center" },
                               { label: "入库数量", name: "m_qty", width: 80, align: "center", statistics: true },
                               { label: "批次", name: "m_batch", width: 80, align: "center" },
                               { label: "商品税率", name: "m_goodsitax", width: 80, align: "center" },
                               { label: "价格", name: "m_price", width: 70, align: "center" },
                               { label: "备注", name: "m_remark", width: 80, align: "center" },
                               { label: "入库时间", name: "m_createdate", width: 150, align: "center" },
                               { label: "添加人", name: "m_createby", width: 80, align: "center" },
                ],
                mainId: 'ID',
                footerrow: true,
                isPage: true,
            ...
            $('#girdtable_Outbounddetails').jfGrid({
                ...
                headData: [
                               ...
                               { label: "单位", name: "c_unit", width: 80, align: "center" },
                               { label: "批次", name: "c_batch", width: 80, align: "center" },
                               { label: "价格", name: "c_price", width: 70, align: "center" },
                               { label: "备注", name: "c_remark", width: 1300, align: "left" },
            ...
            $('#girdtable_withdrawingdetails').jfGrid({
                ...
                headData: [
                               ...
                               { label: "单位", name: "b_unit", width: 80, align: "center" },
                               { label: "批次", name: "b_batch", width: 80, align: "center" },
                               { label: "价格", name: "b_price", width: 80, align: "center" },
            ...
            $('#girdtable_materialssales').jfGrid({
                ...
                headData: [
                               ...
                               { label: "税率", name: "s_otax", width: 80, align: "center" },
                               { label: "单位", name: "s_unit", width: 80, align: "center" },
                               { label: "批次", name: "s_batch", width: 80, align: "center" },
                               { label: "价格", name: "s_price", width: 80, align: "center" },
            ...
            $('#girdtable_scrapnumber').jfGrid({
                ...
                headData: [
                               ...
                               { label: "仓库名称", name: "s_stockname", width: 130, align: "left" },
                               { label: "报废数量", name: "s_qty", width: 80, align: "center", statistics: true },
            ...
            $('#girdtable_other').jfGrid({
                ...
                headData: [
                               ...
                               { label: "批次", name: "o_batch", width: 80, align: "center" },
                               { label: "价格", name: "o_price", width: 80, align: "center" },
                               { label: "备注", name: "o_remark", width: 80, align: "center" },
            ...
            $('#girdtable_supplierback').jfGrid({
                ...
                headData: [
                               ...
                               { label: "批次", name: "b_batch", width: 80, align: "center" },
                               { label: "价格", name: "b_price", width: 80, align: "center" },
                               { label: "备注", name: "b_remark", width: 80, align: "center" },
