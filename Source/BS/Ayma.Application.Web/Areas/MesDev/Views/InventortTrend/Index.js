        ...
        initGird: function () {
            $('#girdtable').AuthorizeJfGrid({
                ...
                headData: [
                    ...
                    { label: "初始数量", name: "I_QtyOld", width: 90, align: "left" },
                    { label: "新数量", name: "I_QtyNew", width: 90, align: "left" },
                    { label: "移动数量", name: "I_QtyTrend", width: 90, align: "left" },
                    {
                        label: "操作时间", name: "I_CreateDate", width: 150, align: "left", sort: true,
                        formatter: function (cellvalue, options, rowObject) {
                            return ayma.formatDate(cellvalue, 'yyyy-MM-dd hh:mm:ss');
                        }
                    },
                    { label: "备注", name: "I_Remark", width: 130, align: "left" },
                ],
                mainId:'ID',
                reloadSelected: true,
                isPage: true,
