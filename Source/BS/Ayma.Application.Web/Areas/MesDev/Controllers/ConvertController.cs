...
namespace Ayma.Application.Web.Areas.MesDev.Controllers
{
    ...
    /// 描 述：物料转换对应表
    /// </summary>
    public partial class ConvertController : MvcControllerBase
    {
        private ConvertIBLL convertIBLL = new ConvertBLL();
        ...
        public ActionResult GetPageList(string pagination, string queryJson)
        {
            ...
            var data = convertIBLL.GetPageList(paginationobj, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        {
            convertIBLL.DeleteEntity(keyValue);
            return Success("删除成功！");
        }
        /// <summary>
        /// 保存实体数据（新增、修改）
