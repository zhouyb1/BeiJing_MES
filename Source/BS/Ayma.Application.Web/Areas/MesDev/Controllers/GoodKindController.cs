...
namespace Ayma.Application.Web.Areas.MesDev.Controllers
{
    ...
    /// 描 述：商品二级分类
    /// </summary>
    public partial class GoodKindController : MvcControllerBase
    {
        private GoodKindIBLL goodKindIBLL = new GoodKindBLL();
        ...
        public ActionResult GetPageList(string pagination, string queryJson)
        {
            ...
            var data = goodKindIBLL.GetPageList(paginationobj, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        {
            var Mes_GoodKindData = goodKindIBLL.GetMes_GoodKindEntity( keyValue );
            var jsonData = new {
                Mes_GoodKindData = Mes_GoodKindData,
            };
            return Success(jsonData);
        }
        #endregion
        ...
        {
            goodKindIBLL.DeleteEntity(keyValue);
            return Success("删除成功！");
        }
        /// <summary>
        /// 保存实体数据（新增、修改）
