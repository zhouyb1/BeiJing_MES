                ...
                if ($et.hasClass('am-selectitem-li') || $et.hasClass('am-select-node-cb')) {
                    ...
                    if (_index == -1) {
                        ...
                        if (dfop.multipleMapValue[_index] == undefined) {
                            ...
                            dfop.multipleMapValue[_index] = dfop.data[_index][dfop.value];
                            ...
                            //取消
                            for (var m = 0; m < dfop.multipleValue.length; m++) {
                                 
                                var mValue = dfop.multipleValue[m];
                                
                                if (mValue == dfop.multipleMapValue[_index])
                                {
                                    dfop.multipleText.splice(m, 1);
                                    dfop.multipleValue.splice(m, 1);
                                    break;
                                }
                            }
                            //dfop.multipleText.splice(dfop.multipleMapValue[_index], 1);
                            //console.info(dfop.multipleText);
                            //console.info(dfop.multipleValue);
                            //console.info(dfop.multipleMapValue);
