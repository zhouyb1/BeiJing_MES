...
(function ($, ayma) {
    ...
    $.Uploader = {
        ...
        initRender: function ($self, dfop) {
            ...
            var $uploadBtn;
            if (dfop.readonly != undefined && dfop.readonly == 'readonly') {
                $uploadBtn = $('<a style="display: none" id="Uploader_uploadBtn_' + dfop.id + '" class="btn btn-success Uploader-input-btn">上传</a>');
            } else {
                $uploadBtn = $('<a id="Uploader_uploadBtn_' + dfop.id + '" class="btn btn-success Uploader-input-btn">上传</a>');
            }
