...
namespace Ayma.Application.TwoDevelopment.MesDev
{
    ...
    public interface MaterInBillIBLL
    {
        ...
        /// <returns></returns>
        IEnumerable<Mes_GoodsEntity> GetProductGoodsList(Pagination pagination, string queryJson, string keyword, string stockCode);
        /// <summary>
        ...
        /// <param name="keyword">编码/名称搜索</param>
        /// <returns></returns>
        IEnumerable<Mes_GoodsEntity> GetGoodsList(Pagination pagination, string queryJson, string keyword, string S_Code);
        /// <summary>
        /// 获取成品入库已提交的成品入库
        /// </summary>
        /// <param name="queryJson">查询参数</param>
