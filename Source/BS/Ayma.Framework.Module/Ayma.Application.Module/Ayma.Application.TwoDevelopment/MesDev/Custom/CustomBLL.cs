...
namespace Ayma.Application.TwoDevelopment.MesDev
{
    ...
    /// 描 述：客户表
    /// </summary>
    public partial class CustomBLL : CustomIBLL
    {
        ...
        public IEnumerable<Mes_CustomerEntity> GetList( string queryJson )
        {
            try
            {
                return customService.GetList(queryJson);
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<Mes_CustomerEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return customService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public Mes_CustomerEntity GetEntity(string keyValue)
        {
            try
            {
                return customService.GetEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                customService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(string keyValue, Mes_CustomerEntity entity)
        {
            try
            {
                customService.SaveEntity(keyValue, entity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
