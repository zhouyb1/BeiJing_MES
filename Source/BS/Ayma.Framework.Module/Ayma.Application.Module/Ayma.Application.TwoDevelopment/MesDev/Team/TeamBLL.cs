...
namespace Ayma.Application.TwoDevelopment.MesDev
{
    ...
    /// 描 述：班组表
    /// </summary>
    public partial class TeamBLL : TeamIBLL
    {
        ...
        public IEnumerable<Mes_TeamEntity> GetList( string queryJson )
        {
            try
            {
                return teamService.GetList(queryJson);
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<Mes_TeamEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return teamService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public Mes_TeamEntity GetEntity(string keyValue)
        {
            try
            {
                return teamService.GetEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                teamService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(string keyValue, Mes_TeamEntity entity)
        {
            try
            {
                teamService.SaveEntity(keyValue, entity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
