...
namespace Ayma.Application.TwoDevelopment.MesDev
{
    ...
    /// 描 述：保质期
    /// </summary>
    public partial class PeriodBLL : PeriodIBLL
    {
        ...
        public IEnumerable<Mes_MaterInDetailEntity> GetList( string queryJson )
        {
            try
            {
                return periodService.GetList(queryJson);
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<Mes_MaterInDetailEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return periodService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public Mes_MaterInDetailEntity GetEntity(string keyValue)
        {
            try
            {
                return periodService.GetEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                periodService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(string keyValue, Mes_MaterInDetailEntity entity)
        {
            try
            {
                periodService.SaveEntity(keyValue, entity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
