...
namespace Ayma.Application.TwoDevelopment.MesDev
{
    ...
    /// 描 述：抽检记录
    /// </summary>
    public partial class Mes_InspectBLL : Mes_InspectIBLL
    {
        private Mes_InspectService mes_InspectService = new Mes_InspectService();
        ...
        public IEnumerable<Mes_InspectEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return mes_InspectService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
        ...
        public Mes_InspectEntity GetMes_InspectEntity(string keyValue)
        {
            try
            {
                return mes_InspectService.GetMes_InspectEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                mes_InspectService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
