...
namespace Ayma.Application.TwoDevelopment.MesDev
{
    ...
    /// 描 述：仓库列表
    /// </summary>
    public partial class StockListBLL : StockListIBLL
    {
        ...
        public IEnumerable<Mes_StockEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return stockListService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
        ...
        public Mes_StockEntity GetMes_StockEntity(string keyValue)
        {
            try
            {
                return stockListService.GetMes_StockEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                stockListService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(string keyValue, Mes_StockEntity entity)
        {
            try
            {
                stockListService.SaveEntity(keyValue, entity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
