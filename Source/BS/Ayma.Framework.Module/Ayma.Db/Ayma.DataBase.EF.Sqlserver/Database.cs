...
namespace Ayma.DataBase.SqlServer
{
    ...
    public class Database : IDatabase
    {
        ...
        /// 连接字符串
        /// </summary>
        public string connecString { get; set; }
        /// <summary>
        /// 获取 当前使用的数据访问上下文对象
        /// </summary>
        ...
        {
            using (var connection = new SqlConnection(connecString))
            {
                using (var sqlBulkCopy = new SqlBulkCopy(connecString, SqlBulkCopyOptions.UseInternalTransaction))
                {
                    try
                    {
