...
namespace Ayma.Util.Operat
{
    ...
    public class OperatorHelper
    {
        ...
        private string cacheKeyOperator = "ayma_mes_operator_";// +登录者token
        private string cacheKeyToken = "ayma_mes_token_";// +登录者token
        private string cacheKeyError = "ayma_mes_error_";// + Mark
        /// <summary>
        /// 秘钥
        /// </summary>
        private string LoginUserToken = "Ayma_Mes_Token";
        /// <summary>
        /// 标记登录的浏览器
        /// </summary>
        private string LoginUserMarkKey = "Ayma_Mes_Mark";
